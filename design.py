...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout.addWidget(self.videoWidget, 0, 0, 1, 6)
        ...
        self.gridLayout.addWidget(self.prevBtn, 1, 2, 1, 1)
        self.playBtn = QtWidgets.QPushButton(self.centralwidget)
        self.playBtn.setObjectName("playBtn")
        self.gridLayout.addWidget(self.playBtn, 1, 3, 1, 1)
        self.pauseBtn = QtWidgets.QPushButton(self.centralwidget)
        self.pauseBtn.setObjectName("pauseBtn")
        self.gridLayout.addWidget(self.pauseBtn, 1, 4, 1, 1)
        self.horizontalSlider = QtWidgets.QSlider(self.centralwidget)
        self.horizontalSlider.setOrientation(QtCore.Qt.Horizontal)
        self.horizontalSlider.setObjectName("horizontalSlider")
        self.gridLayout.addWidget(self.horizontalSlider, 1, 5, 1, 1)
